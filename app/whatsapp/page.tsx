...
// Dicionário de dados (Reaproveitado para manter a consistência da mensagem)
const locationsData = {
...
function RedirectContent() {
  ...
  useEffect(() => {
    ...
    // TEMPO DE ESPERA PARA O TRACKING (3 segundos)
    // Isso garante que o Pixel da Meta ou Google Analytics tenha tempo de registrar a visita
